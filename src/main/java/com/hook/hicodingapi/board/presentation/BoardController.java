...
public class BoardController {
    ...
    public ResponseEntity<PostReadResponse> getRequestedPost(@PathVariable final String boardType,
        ...
        final BoardType convertedBoardType = BoardType.fromValue(boardType);
        final PostReadResponse postReadResponse = PostReadResponse.from(
                boardService.findPost(convertedBoardType, postNo
                ));
    ...
    public ResponseEntity<PostCreationResponse> saveRequestedPost(@PathVariable final String boardType,
    ...
    public ResponseEntity<Void> updateRequestedPost(@PathVariable final String boardType,
                                                    @PathVariable final Long postNo,
                                                    @RequestBody final PostUpdateRequest postUpdateRequest) {
        final BoardType convertedBoardType = BoardType.fromValue(boardType);
        boardService.updatePost(convertedBoardType, postNo, postUpdateRequest);
    ...
    public ResponseEntity<Void> deleteRequestedPost(@PathVariable final String boardType,
                                                    @PathVariable final Long postNo) {
